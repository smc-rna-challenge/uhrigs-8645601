SMC-RNA Challenge Entry: uhrigs-8645601
========================================================
...
```bash
# Clone this repo
git clone https://github.com/smc-rna-challenge/uhrigs-8645601
cd uhrigs-8645601
...
- [quay.io/smc-rna-challenge/uhrigs-8645601-smc-rna-challenge-4:1.0.0](https://quay.io/smc-rna-challenge/uhrigs-8645601-smc-rna-challenge-4:1.0.0)
...
highly recurrent fusions from CancerGeneCensus
...
immunoglobulin (IG) rearrangements in tumor samples infiltrated by immune cells, nuclear mitochondrial DNA, read-through chimeras produced by co-transcription of adjacent genes
...
[data]: https://www.synapse.org/#!Synapse:syn9878887
